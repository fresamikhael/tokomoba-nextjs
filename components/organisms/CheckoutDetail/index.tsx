    ...
    <>
      <div className="purchase pt-md-50 pt-30">
        ...
        <p className="text-lg color-palette-1 mb-20">
          Your Game ID <span className="purchase-details">fresamikhael</span>
        </p>
        <p className="text-lg color-palette-1 mb-20">
      ...
      <div className="payment pt-md-50 pb-md-50 pt-10 pb-10">
        ...
        <p className="text-lg color-palette-1 mb-20">
          Your Account Name
          <span className="purchase-details">Fresa Mikhael</span>
        </p>
        <p className="text-lg color-palette-1 mb-20">
        ...
        <p className="text-lg color-palette-1 mb-20">
          Bank Account Name
          <span className="payment-details">PT Tokomoba Indonesia</span>
        </p>
        <p className="text-lg color-palette-1 mb-20">
          Bank Number{" "}
